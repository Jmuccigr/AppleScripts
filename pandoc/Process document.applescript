...
on run
	...
	set revealConfig to " -i --self-contained --slide-level=2 -V center=false -V theme=gray_lecture -V transition=fade -V transitionSpeed=slow -V width=\\" & quote & "100%\\" & quote & " -V height=\\" & quote & "100%\\" & quote & " -V margin=0 -V revealjs-url=" & quoted form of (myGit & "reveal.js/")

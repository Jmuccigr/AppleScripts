...
/usr/local/bin/convert +repage " & fname & " \\( -size ${size}x${size} -background white xc: \\) -gravity southeast -compose over -composite -fuzz 2% -trim -bordercolor white -border " & border & " +repage $TMPDIR/tempfile.png"
